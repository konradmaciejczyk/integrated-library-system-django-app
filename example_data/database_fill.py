...
from user_side.models import Citizenship, Gender, IDDocumentType, Occupation
...
id_doc_types = (('ID Card'), ('Passport'))

occupations = (('Student'), ('Academic teacher'), ('Other'))
...
for id_doc_type in id_doc_types:
    buff = IDDocumentType(name=id_doc_type)
    buff.save()
